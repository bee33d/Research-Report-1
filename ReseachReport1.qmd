...
For H2, I test whether the **mean** country-level deviation differs across cultural contexts. A one-way ANOVA answers this directly. I use weights (`n`) so that countries with larger samples contribute proportionally more information. I also set the reference level to "Catholic" so the intercept has a clear baseline interpretation.
